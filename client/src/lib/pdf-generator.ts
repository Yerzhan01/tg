...
export class PDFGenerator {
  ...
  private static readonly LAYOUT = {
    ...
    servicesTable: {
      ...
      rowHeight: 8,
      cols: [
        { width: 8 },    // № - еще уменьшил
        { width: 12 },   // Код - еще уменьшил  
        { width: 65 },   // Наименование - уменьшил
        { width: 16 },   // Кол-во - уменьшил
        { width: 12 },   // Ед. - уменьшил
        { width: 38 },   // Цена - увеличил
        { width: 49 }    // Сумма - значительно увеличил для полной видимости
      ]
    },
